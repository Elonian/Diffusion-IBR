...
except Exception:  # pragma: no cover - depends on nerfstudio version
    ViewerLegacyState = None
...
class Difix3DTrainer(Trainer):
    ...
    def setup(self, test_mode: Literal["test", "val", "inference"] = "val") -> None:
        ...
        if self.config.is_viewer_legacy_enabled() and self.local_rank == 0:
            if ViewerLegacyState is None:
                raise ImportError("Legacy viewer support is unavailable in this nerfstudio installation.")
